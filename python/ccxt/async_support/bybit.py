...
class bybit(Exchange):
    ...
    async def fetch_markets(self, params={}):
        ...
        if type == 'spot':
            ...
            return spotMarkets
        contractMarkets = await self.fetch_swap_and_future_markets(params)
        usdcMarkets = await self.fetch_usdc_markets(params)
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        take_profit = self.safe_value(params, 'take_profit')
        if take_profit:
            request['take_profit'] = take_profit
        stop_loss = self.safe_value(params, 'stop_loss')
        if stop_loss:
